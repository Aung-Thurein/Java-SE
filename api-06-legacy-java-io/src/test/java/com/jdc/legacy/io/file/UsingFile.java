...
public class UsingFile {
	...
	void test_create_file_object() throws IOException
	{
		...
		file.deleteOnExit();
		System.out.printf("Test File is exist : %s%n", file.exists());
